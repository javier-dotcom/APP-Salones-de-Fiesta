...
justify-content: flex-start;
  ...
  animation: slide-in 1.3s forwards; /* Aplica la animación "slide-in" */
}
...
p {
  opacity: 0; /* Inicialmente, establece la opacidad en 0 */
  transform: translateX(-100%); /* Mueve los elementos fuera del área visible */
  animation: slide-in 2.7s forwards; /* Aplica la animación "slide-in" */
}
...
<br>
<details>
    <summary>Detalles  <?php echo$cont?>° Evento mas cercano</summary>
...
if($fila1["tipo_evento"] =="bautismo"){
  ?>
    ...
    <a class="tarjeta" href="resumen_comunion.php?id=<?php echo $id ?>&id_evento=<?php echo $id_evento ?>">Enviar resumen  </a>
