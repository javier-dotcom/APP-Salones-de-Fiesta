...
button,.m {
  opacity: 0; /* Inicialmente, establece la opacidad en 0 */
  transform: translateX(-100%); /* Mueve los elementos fuera del área visible */
  animation: slide-in 2.3s forwards; /* Aplica la animación "slide-in" */
}
...
<br>
  ...
  <div class="buscar2">
    ...
    <br>
    <form class="row g-3 imp" action="registro_de_pago.php" method="get">
...
$id_evento=$fila['id_evento'];
    ...
    ?>
      ...
      <div class="n">
            <p> "<?php
                  if ($fila["tipo_evento"] == "comunion") {

                    echo $fila["nombre_cumpleaniero"] ?>" Toma su 1° Comunion <?php


                                                                        } elseif ($fila["tipo_evento"] == "bautismo") {

                                                                          echo $fila["nombre_cumpleaniero"] ?>" Se Bautiza <?php
                                                                        } else {

                                                                          echo $fila["nombre_cumpleaniero"] ?>" Cumple sus <?php echo $fila["anios_a_cumplir"] . " añitos ";
                                                                        }
        ...
        <?php  
  $datos4="SELECT * FROM pagos WHERE id_evento = $id_evento";
...
<div class="y">
            <p > <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
  ...
  <path d="M1 0a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h4.083c.058-.344.145-.678.258-1H3a2 2 0 0 0-2-2V3a2 2 0 0 0 2-2h10a2 2 0 0 0 2 2v3.528c.38.34.717.728 1 1.154V1a1 1 0 0 0-1-1H1z"/>
  <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 5.982 5.982 0 0 1 3.13-1.567z"/>
</svg> <span>Resta abonar  :  <span>Resta abonar  : </span> <?php
                                         $_SESSION["resta_pagar"]= ($fila4["costo"]-$fila4["entrega_hecha"]);
...
<div class="n">
        ...
        <form action="registro_de_pago1.php" method="get">
...
<input class="tarjeta"type="submit" value="Cargar pago" name="pagar1">
...
<!-- 
        ...
        <div class="zzz">
          ...
          <br>
          <a class="tarjeta" href="resumen_comunion.php?id=<?php echo $id?>&id_evento=<?php echo $fila["id_evento"]; ?>" >Ver resumen del evento  </a>
          <br>
    ...
    ?>
      <div class="m">
        ...
        <div class="z">
          ...
          <div class="y">
            <p> <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
                <path d="M2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2zm3.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                <path d="M1.293 7.793A1 1 0 0 1 1 7.086V2a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l.043-.043-7.457-7.457z" />
              </svg> <span> Costo </span> <?php echo $fila["costo"]; ?> $</p>
          </div>
          ...
          <div class="y">
            <p><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-telephone-outbound-fill" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511zM11 .5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V1.707l-4.146 4.147a.5.5 0 0 1-.708-.708L14.293 1H11.5a.5.5 0 0 1-.5-.5z" />
              </svg> <span> Telèfono </span> <?php echo $fila["telefono_contacto"]; ?> </p>
          </div>
          ...
          <div class="y">
            <p > <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-hourglass-top" viewBox="0 0 16 16">
                <path d="M2 14.5a.5.5 0 0 0 .5.5h11a.5.5 0 1 0 0-1h-1v-1a4.5 4.5 0 0 0-2.557-4.06c-.29-.139-.443-.377-.443-.59v-.7c0-.213.154-.451.443-.59A4.5 4.5 0 0 0 12.5 3V2h1a.5.5 0 0 0 0-1h-11a.5.5 0 0 0 0 1h1v1a4.5 4.5 0 0 0 2.557 4.06c.29.139.443.377.443.59v.7c0 .213-.154.451-.443.59A4.5 4.5 0 0 0 3.5 13v1h-1a.5.5 0 0 0-.5.5zm2.5-.5v-1a3.5 3.5 0 0 1 1.989-3.158c.533-.256 1.011-.79 1.011-1.491v-.702s.18.101.5.101.5-.1.5-.1v.7c0 .701.478 1.236 1.011 1.492A3.5 3.5 0 0 1 11.5 13v1h-7z" />
              </svg> <span> Comienzo</span> <?php echo $hora_comienzo; ?> hs</p>
          </div>
          ...
          <div class="y">
            <p > <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-hourglass-bottom" viewBox="0 0 16 16">
                <path d="M2 1.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-1v1a4.5 4.5 0 0 1-2.557 4.06c-.29.139-.443.377-.443.59v.7c0 .213.154.451.443.59A4.5 4.5 0 0 1 12.5 13v1h1a.5.5 0 0 1 0 1h-11a.5.5 0 1 1 0-1h1v-1a4.5 4.5 0 0 1 2.557-4.06c.29-.139.443-.377.443-.59v-.7c0-.213-.154-.451-.443-.59A4.5 4.5 0 0 1 3.5 3V2h-1a.5.5 0 0 1-.5-.5zm2.5.5v1a3.5 3.5 0 0 0 1.989 3.158c.533.256 1.011.791 1.011 1.491v.702s.18.149.5.149.5-.15.5-.15v-.7c0-.701.478-1.236 1.011-1.492A3.5 3.5 0 0 0 11.5 3V2h-7z" />
              </svg> <span>Finalizacion</span><?php echo $hora_fin; ?> hs</p>
          </div>
...
</svg> <span>Resta abonar  : </span> <?php
                                         $_SESSION["resta_pagar"]= ($fila4["costo"]-$fila4["entrega_hecha"]);
                                         echo $_SESSION["resta_pagar"];
