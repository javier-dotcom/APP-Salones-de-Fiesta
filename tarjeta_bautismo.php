...
<head>
    ...
    <title>Tarjetas virtuales</title>
...
FROM evento 
INNER JOIN imagen_bautismo ON imagen_bautismo.id_imagen = evento.id_imagen 
...
<?php 
    ...
    <img class="nombre" src="data:image/jpg;base64,<?php echo base64_encode($fila['imagen_imagen']) ?>" width="350px" height="600px">

		<div class="text"><?php echo $fila["nombre_cumpleaniero"]; ?> <br> <span>
...
<br>
        ...
        ?>
        <div class="texto">
            <h2 class="aaaa">Mi bautismo es el día </h2>
    </h2>
        <br>
<div class="fe">
...
<?php echo  date("d-m-Y", strtotime($fila["fecha_evento"])); ?>
        ...
        <div class="aa">
        <a class="href agendar"href="https://api.whatsapp.com/send?phone=<?php echo ($fila['telefono_contacto']) ?>&text=Hola,%20confirmo%20que%20asisitiré%20al%20Bautismo""> CONFIRMAR ASISITENCIA <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-checks" width="36" height="36" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
  ...
  <path d="M2 12l5 5m5 -5l5 -5" />
            ...
            if ($tiempo_restante > 0) {
                ...
                $mensaje = "FALTAN     <span> $dias_restantes  <br> </span> DIAS      PARA <br>MI BAUTISMO";
            } else if ($tiempo_restante == 0) {
                $mensaje = "HOY ES MI BAUTISMO";
            } else {
                $mensaje = "EL BAUTISMO YA PASO";
            }
  ...
  <path d="m14 9.293-6-6-6 6V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V9.293Zm-6-.811c1.664-1.673 5.825 1.254 0 5.018-5.825-3.764-1.664-6.691 0-5.018Z"/>
    ...
    <script>
        document.getElementById('compartir-whatsapp').addEventListener('click', function() {
            ...
            var mensaje = encodeURIComponent(' <?php echo $nom;?>Te invita a su Bautismo ' + url);
