...
<div class="todo">
    ...
    <h2>Agendar nuevo Bautismo</h2>
    <!--<h2>Eventos web</h2>-->
    <p>Cargá los datos del bautismo y hacé clik en guardar datos</p>
    <div class="todo">
        <form class="row g-3 " action="agendar_evento1.php" method="get">
            ...
            <input type="hidden" name="tipoEvento" value="bautismo" class="form-control input">
