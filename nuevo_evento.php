...
<head>
  ...
  <title>Nuevo evento agendado</title>
  <style>
    .botonArriba1 {
      position: fixed;
      bottom: 65px;
...
<div class="todo">
  ...
  <nav class="navbar navbar-dark f ">
    ...
    <img class="img" src="data:image/jpg;base64,<?php echo base64_encode($fila['logo_salon']) ?>" width="50px" height="40px">
      <a class="navbar-brand " href="#"><?php echo $fila["nombre_salon"]?></a>
  ...
  <h2> Perfecto se agendo el evento &nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
  ...
  $cont = 0;
  $dato1 = "  SELECT *  from evento where id_evento order by id_evento DESC LIMIT 1 ";
...
<br> -->
  ...
  ?>
    ...
    <!-- <h2>Detalles del evento registrado</h2> -->
    <h2>
        ...
        <div class="z">
          <div class="y">
            <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
              ...
              </svg> <span>Invitados</span>Total : <?php echo ($fila1["cant_adultos"] + $fila1["cant_nenes"]);
                                                    $mensaje .= " hay " .  ($fila1["cant_adultos"] + $fila1["cant_nenes"]) . " invitados " ?> </p>
          </div>
          <div class="y">
          ...
          <div class="y">
            <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
              ...
              </svg> <span> Costo : </span> <?php echo $fila1["costo"];
                                            $mensaje .= ". Costo del evento " . $fila1["costo"] ?> $</p>
          </div>
          ...
          <div class="y">
            <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-outbound-fill" viewBox="0 0 16 16">
              ...
              </svg> <span> Telèfono : </span> <?php echo $fila1["telefono_contacto"];
                                                $telef = $fila1["telefono_contacto"] ?> </p>
          </div>
          ...
          <div class="y">
            <p class="hora"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hourglass-top" viewBox="0 0 16 16">
              ...
              </svg> <span> Comienzo : </span> <?php echo $hora_comienzo;
                                                $mensaje .= ". Comienza a las " . $hora_comienzo ?> hs</p>
          </div>
          ...
          <div class="y">
            <p class="hora"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hourglass-bottom" viewBox="0 0 16 16">
              ...
              </svg> <span>Finalizacion : </span> <?php echo $hora_fin;
                                                  $mensaje .= " y termina a las " . $hora_fin . "hs del " . date(" d-m-Y", strtotime($fila1["fecha_evento"])) ?> hs</p>
          </div>
    ...
    <div class="zzz">
      ...
      ?>
      <br>
      <a class="tarjeta" href="resumen_comunion.php?id=<?php echo $id; ?>&id_evento=<?php echo $id_evento; ?>"> Crear resumen del evento </a>
      <br>
      <div class="zz">
        <div class="n">
          <?php
          ...
          echo"Resta Pagar : " . $_SESSION["resta_pagar"];
          ?>



          <form action="registro_de_pago1.php" method="get">
            <h2>INGRESAR PAGO</h2> <br>
