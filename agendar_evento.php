...
.h{
 ...
 .f{
      /* background: linear-gradient(90deg, rgba(230, 63, 30, 0.3) 26%, rgba(153, 29, 8, 1) 55%); */
	border-bottom: solid 2px rgb(248, 15, 15);
  text-align:center ;
  width: 90%;
  margin: auto;
 }
...
<body>
 <div class="todo">
  ...
  <h2>Agendar cumple !!</h2>
  <!--<h2>Eventos web</h2>-->
  <p>Carga los datos del evento y hacé clik en guardar datos</p>

    <form  class="row g-3 " action="agendar_evento1.php" method="get" >
      ...
      <div class="col-md-4">
        ...
        <input type="hidden" name="tipoEvento" value="cumpleinfanti" class="form-control input">
      ...
      <div class="col-md-4">
        <label for="validationDefault02" class="form-label">Nombre cumpleañero</label>
        <input type="text" class="form-control input" id="validationDefault02" name="nombreCumplea" required>
      </div>

      <div class="col-md-4">
        <label for="validationDefault03" class="form-label">Años a cumplir</label>
        <input type="text" class="form-control input" id="validationDefault03" name="anioACumplir" required>
      </div>

      <div class="col-md-4">
        <label for="validationDefault03" class="form-label">Cantidad de niños</label>
        <input type="number"  class="form-control input" id="validationDefault03" name="cantidadNenes"required>
      </div>

      <div class="col-md-4">
        <label for="validationDefault03" class="form-label">Cantidad de adultos</label>
        <input type="number"  class="form-control input" id="validationDefault03" name="cantidadAdultos"required>
      </div>

      <div class="col-md-4">
        <label for="validationDefault03" class="form-label">Costo</label>
        <input type="number"  class="form-control input" id="validationDefault03" name="costo"required>
      </div>
      ...
      <!-- <div class="col-md-4">
        <label for="validationDefault03" class="form-label">Fecha del cumpleaños (no del evento)</label>
        <input type="date"  class="form-control input" id="validationDefault03" name="fechaCumpleLiteral"required>
      </div> -->
...
while ($fila=mysqli_fetch_array($consulta)) {
 ?> <option value="<?php echo$fila['id_imagen'];  ?>"> <?php echo  strtoupper($fila["nombre_imagen"]) ;echo " (id : " . $fila['id_imagen'] . ")";  ?></option> <?php 
}
?>
          </select>
        </div>
