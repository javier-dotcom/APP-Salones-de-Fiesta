...
<body>
  <div class="todo">
    ...
    while ($fila1 = mysqli_fetch_array($consulta1)) {
      ...
      $datos3 = "SELECT * from pagos where id_evento = $fila1[id_evento]";
      $consulta3 = mysqli_query($conexion, $datos3);
      $fila3 = mysqli_fetch_array($consulta3);
      $id_evento1=$fila1["id_evento"];
            ...
            <div class="z">
              <div class="y">
                <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                  ...
                  </svg> <span>Invitados</span>Total : <?php echo ($fila1["cant_adultos"] + $fila1["cant_nenes"]); ?> </p>
              </div>
              <div class="y">
              ...
              <div class="y">
                <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
                  ...
                  </svg> <span> Costo : </span> <?php echo $fila1["costo"]; ?> $</p>
              </div>
              ...
              <div class="y">
                <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
                    <path d="M2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2zm3.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                    <path d="M1.293 7.793A1 1 0 0 1 1 7.086V2a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l.043-.043-7.457-7.457z" />
                  </svg> <span> Total pagos hechos : </span> <?php echo $fila3["entrega_hecha"]; ?> $</p>
              </div>
              ...
              <div class="y">
                <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
                    <path d="M2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2zm3.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z" />
                    <path d="M1.293 7.793A1 1 0 0 1 1 7.086V2a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l.043-.043-7.457-7.457z" />
                  </svg> <span> Resta Abonar : </span> <?php echo $fila3["costo"] - $fila3["entrega_hecha"];
                  $max= $fila3["costo"] - $fila3["entrega_hecha"];?> $</p>
              </div>
...
<td><?php echo "$ " .  $fila1["costo"] - $fila1["entrega_hecha"] ?></td>
            ...
            <div class="zzz">
              ...
              ?>
                ...
                <br>
                <a class="tarjeta" href="registro_de_pago2.php?id=<?php echo $id ?>&id_evento=<?php echo $fila1["id_evento"] ?>">Ver resumen pagos </a>
                <br>
            <h2>INGRESAR PAGO <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
</svg></h2> <br>
   

    <form class="pa" action="registro_de_pago1.php" method="get">
            <input type="hidden" name="id_evento" value="<?php echo $id_evento1;?>">

            <input  class="tarjeta" type="number" name="pago" placeholder="$_ _ _ _ _ _ _" max="<?php echo$max;?>"><br>
            <input class="tarjeta" type="submit" value="Cargar pago" name="pagar1">
<?php 
$sesion_cargada=FALSE;
if(isset($_GET["pagar1"])and  $sesion_cargada== FALSE){

$_SESSION["resta_pagar"]=($fila3["costo"] - $fila3["entrega_hecha"]);
$sesion_cargada=TRUE;
